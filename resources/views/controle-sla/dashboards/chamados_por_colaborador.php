<!-- TRECHO QUE FAZ O DASHBOARD FUNCIONAR (LEMBRE-SE QUE EXISTE UM CSS NO /PUBLIC NECESSARIO*/ -->   
  ...
  <?php
    $chamadosPorDev = $chamadosAssumidosSLA->calculaQtChamadosPorDev();
    // echo "<pre>";
    // print_r($chamadosPorDev);
    //o primeiro indice é o mes, o segundo é o id do tb_solicitante_sla. Caso for incluir um novo colaborador, inclua ali no name-data com o id e nome correto
  ?>
<script>
Highcharts.chart('container2', {
  ...
  title: {
    text: 'Total de chamados assumidos por colaborador'
  },
  subtitle: {
    text: ''
  },
